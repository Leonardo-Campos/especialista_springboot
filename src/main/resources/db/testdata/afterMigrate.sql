...
(1, 'Leo', 'wearelariandleo@gmail.com', '123', utc_timestamp),
(2, 'Ruan', ' ruanolisilva19@gmail.com', '123', utc_timestamp),
...
(6, 'Débora Mendonça', 'wearelariandleo+debora@gmail.com', '123', utc_timestamp),
(7, 'Leonardo', 'wan.orcamentos@wanacos.com.br', '123', utc_timestamp);
...
values (1, 'f9981ca4-5a5e-4da3-af04-933861df3e55', 1, 7, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
	                status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, 'd178b637-a785-4768-a3cb-aa1ce5a8cdab', 4, 2, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
